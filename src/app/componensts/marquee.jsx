...
function Marquee() {
    ...
    const offers = [
        "Pakistan’s #1 Makeup Brand Since 2007",
            ...
            <Fragment key={index}>
              {offers.map((item, index) => (
                <div
                  ...
                  key={index}
                >
                  <p className="text-pink-400 text-xl">&#10038;</p>
                  <p className=" bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent text-md font-medium">
                    {item}
                  </p>
                </div>
              ))}
